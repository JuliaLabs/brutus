...
# CHECK-NEXT:     %2 = "jlir.convertstd"(%arg3) : (i64) -> !jlir.Int64
# CHECK-NEXT:     %3 = "jlir.convertstd"(%arg4) : (i64) -> !jlir.Int64
# CHECK-NEXT:     %4 = "jlir.convertstd"(%true) : (i1) -> !jlir.Bool
# CHECK-NEXT:     %5 = "jlir.arrayref"(%4, %0, %1, %2, %3) : (!jlir.Bool, !jlir<"Array{Int64, 3}">, !jlir.Int64, !jlir.Int64, !jlir.Int64) -> !jlir.Int64
# CHECK-NEXT:     %6 = "jlir.convertstd"(%5) : (!jlir.Int64) -> i64
...
# CHECK: module  {
# CHECK-NEXT:   llvm.func @"Tuple{typeof(Main.index), Array{Int64, 3}, Int64, Int64, Int64}"(%arg0: !llvm.ptr<struct<"struct_jl_value_type", opaque>>, %arg1: !llvm.ptr<i64>, %arg2: !llvm.ptr<i64>, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: i64, %arg11: i64, %arg12: i64) -> i64 attributes {llvm.emit_c_interface, sym_visibility = "nested"} {
...
# CHECK-NEXT:     %11 = "jlir.arrayref"(%10, %9, %arg10, %arg11, %arg12) : (i1, !llvm.struct<(ptr<i64>, ptr<i64>, i64, array<3 x i64>, array<3 x i64>)>, i64, i64, i64) -> !jlir.Int64
