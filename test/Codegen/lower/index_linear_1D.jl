...
# CHECK-NEXT:     %0 = "jlir.arraytomemref"(%arg1) : (!jlir<"Array{Int64, 1}">) -> memref<?xi64>
# CHECK-NEXT:     %1 = "jlir.convertstd"(%arg2) : (i64) -> index
# CHECK-NEXT:     %2 = subi %1, %c1 : index
# CHECK-NEXT:     %3 = load %0[%2] : memref<?xi64>
...
# CHECK-NEXT:     %9 = llvm.mlir.undef : !llvm<"{ i64*, i64*, i64, [1 x i64], [1 x i64] }">
# CHECK-NEXT:     %10 = llvm.insertvalue %6, %9[0] : !llvm<"{ i64*, i64*, i64, [1 x i64], [1 x i64] }">
# CHECK-NEXT:     %11 = llvm.insertvalue %6, %10[1] : !llvm<"{ i64*, i64*, i64, [1 x i64], [1 x i64] }">
# CHECK-NEXT:     %12 = llvm.insertvalue %2, %11[2] : !llvm<"{ i64*, i64*, i64, [1 x i64], [1 x i64] }">
# CHECK-NEXT:     %13 = llvm.getelementptr %8[%2] : (!llvm<"i64*">, !llvm.i64) -> !llvm<"i64*">
# CHECK-NEXT:     %14 = llvm.load %13 : !llvm<"i64*">
# CHECK-NEXT:     %15 = llvm.insertvalue %14, %12[3, 0] : !llvm<"{ i64*, i64*, i64, [1 x i64], [1 x i64] }">
# CHECK-NEXT:     %16 = llvm.mlir.constant({{[0-9]+}} : i64) : !llvm.i64
# CHECK-NEXT:     %17 = llvm.insertvalue %16, %15[4, 0] : !llvm<"{ i64*, i64*, i64, [1 x i64], [1 x i64] }">
# CHECK-NEXT:     %18 = llvm.sub %arg2, %0 : !llvm.i64
# CHECK-NEXT:     %19 = llvm.extractvalue %17[1] : !llvm<"{ i64*, i64*, i64, [1 x i64], [1 x i64] }">
# CHECK-NEXT:     %20 = llvm.mlir.constant(0 : index) : !llvm.i64
# CHECK-NEXT:     %21 = llvm.mul %18, %0 : !llvm.i64
