...
# CHECK: module  {
# CHECK-NEXT:   func nested @"Tuple{typeof(Main.select), Bool}"(%arg0: !jlir<"typeof(Main.select)">, %arg1: !jlir.Bool, %arg2: !jlir.Int64) -> !jlir.Int64 attributes {llvm.emit_c_interface} {
...
# CHECK: module  {
# CHECK-NEXT:   func nested @"Tuple{typeof(Main.select), Bool}"(%arg0: !jlir<"typeof(Main.select)">, %arg1: i1, %arg2: i64) -> i64 attributes {llvm.emit_c_interface} {
...
# CHECK: module  {
# CHECK-NEXT:   llvm.func @"Tuple{typeof(Main.select), Bool}"(%arg0: !llvm.ptr<struct<"struct_jl_value_type", opaque>>, %arg1: i1, %arg2: i64) -> i64 attributes {llvm.emit_c_interface, sym_visibility = "nested"} {
...
# CHECK-NEXT:     %3 = llvm.select %arg1, %2, %1 : i1, i64
# CHECK-NEXT:     %4 = llvm.add %3, %0  : i64
# CHECK-NEXT:     llvm.return %4 : i64
# CHECK-NEXT:   }
# CHECK-NEXT:   llvm.func @"_mlir_ciface_Tuple{typeof(Main.select), Bool}"(%arg0: !llvm.ptr<struct<"struct_jl_value_type", opaque>>, %arg1: i1, %arg2: i64) -> i64 attributes {llvm.emit_c_interface, sym_visibility = "nested"} {
# CHECK-NEXT:     %0 = llvm.call @"Tuple{typeof(Main.select), Bool}"(%arg0, %arg1, %arg2) : (!llvm.ptr<struct<"struct_jl_value_type", opaque>>, i1, i64) -> i64
